...
// node_modules/.pnpm/wavesurfer.js@7.8.2/node_modules/wavesurfer.js/dist/wavesurfer.esm.js
...
var h = class _h extends e {
  ...
  renderMultiCanvas(t2, e2, i2, s2, n2, r2) {
    ...
    if (a2 * o2 >= i2) return void this.renderSingleCanvas(t2, e2, a2, s2, 0, n2, r2);
    const l2 = i2 / o2;

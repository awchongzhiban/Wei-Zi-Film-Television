(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.VContextmenu = {}, global.Vue));
  ...
  var bind = function bind(el, binding) {
    ...
    var contextmenuInstance = vue.isRef(contextmenuKey) ? contextmenuKey.value : (_binding$instance = binding.instance) === null || _binding$instance === void 0 ? void 0 : _binding$instance.$refs[contextmenuKey];
  ...
  var unbind = function unbind(el, binding) {
    ...
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    var contextmenuInstance = vue.isRef(contextmenuKey) ? contextmenuKey.value : (_binding$instance2 = binding.instance) === null || _binding$instance2 === void 0 ? void 0 : _binding$instance2.$refs[contextmenuKey];
    if (!contextmenuInstance) {
      console.error("\u6CA1\u6709\u627E\u5230 ".concat(contextmenuKey, " \u5BF9\u5E94\u7684\u5B9E\u4F8B"));
      return;
    }
  ...
  var Contextmenu = vue.defineComponent({
    ...
    setup: function setup(props, _ref) {
      ...
      vue.provide('autoAdjustPlacement', props.autoAdjustPlacement);
    ...
    render: function render() {
      ...
      return this.teleport ? vue.createVNode(vue.Teleport, {
        "to": this.teleport
  ...
  var ContextmenuSubmenu = vue.defineComponent({
    ...
    setup: function setup(props, _ref) {
      ...
      var autoAdjustPlacement = vue.inject('autoAdjustPlacement');
    ...
    render: function render() {
      ...
      }, [((_this$$slots$title = (_this$$slots = this.$slots).title) === null || _this$$slots$title === void 0 ? void 0 : _this$$slots$title.call(_this$$slots)) || this.title, vue.createVNode("span", {
        "class": CLASSES.contextmenuSubmenuArrow
      }, [vue.createVNode(ContextmenuIcon, {
        "name": "right-arrow"
      }, null)])]), this.hover ? vue.createVNode("div", {
        "ref": "submenuRef",
  ...
  var ContextmenuGroup = vue.defineComponent({
    ...
    render: function render() {
      ...
      }, [this.renderTitle(), vue.createVNode("ul", {
        "style": this.style,

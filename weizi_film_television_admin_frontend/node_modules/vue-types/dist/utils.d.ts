import { VueTypeDef, VueTypeValidableDef, VueProp, InferType, PropOptions, VueTypesConfig } from './types';
 ...
 */
export declare const has: <T, U extends keyof T>(obj: T, prop: U) => any;
/**
 ...
 * @returns {boolean}
 */
export declare const isFunction: <T extends Function>(value: unknown) => value is T;
/**
 ...
 */
export declare function unwrap<T extends WrappedFn | Function>(fn: T): Function;
/**

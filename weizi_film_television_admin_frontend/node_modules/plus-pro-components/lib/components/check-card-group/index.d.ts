...
export declare const PlusCheckCardGroup: import("vue").DefineComponent<{
    modelValue: {
    ...
    props: any;
    emit: (event: "update:modelValue" | "change" | "extra", ...args: any[]) => void;
    state: import("./src/index.vue").CheckCardState;
    getChecked: (value: import("./src/index.vue").SingleValueType) => boolean;
    handleChange: (model: boolean, value: import("./src/index.vue").SingleValueType) => void;
    handleExtra: (item: import("..").PlusCheckCardProps & {
        value: string | number;
    }) => void;
    readonly PlusCheckCard: import("vue").DefineComponent<{
        modelValue: {
            type: BooleanConstructor;
            required: false;
            default: boolean;
        ...
        classDataEnum: Record<"default" | "small" | "large", string>;
        props: any;
        emit: (event: "update:modelValue" | "change" | "extra", ...args: any[]) => void;
        state: import("../check-card/src/index.vue").CheckCardState;
        getClass: () => any;
        handleClick: () => void;
        handelExtra: () => void;
        readonly ElAvatar: import("element-plus/es/utils").SFCWithInstall<import("vue").DefineComponent<{
        ...
        readonly isString: (val: any) => boolean;
        readonly isFunction: (val: any) => boolean;
    }, unknown, {}, {}, import("vue").ComponentOptionsMixin, import("vue").ComponentOptionsMixin, ("update:modelValue" | "change" | "extra")[], "update:modelValue" | "change" | "extra", import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps, Readonly<import("vue").ExtractPropTypes<{
        modelValue: {
            type: BooleanConstructor;
            required: false;
            default: boolean;
        ...
        onExtra?: ((...args: any[]) => any) | undefined;
    }, {
        size: any;
        disabled: boolean;

...
import type { PlusColumn, FieldValues, Mutable } from 'plus-pro-components/es/types';
...
declare const _default: import("vue").DefineComponent<{
    ...
    handleChange: (values: FieldValues, column: PlusColumn) => Promise<void>;
    handleSearch: () => Promise<void>;
    handleReset: () => void;
    handleUnfold: () => void;
    isShowUnfold: Ref<boolean>;
    subColumns: Ref<any>;

...
export interface PlusCheckCardProps {
    modelValue?: boolean;
    size?: ComponentSize;
    avatar?: string | ((data: Pick<PlusCheckCardProps, 'avatar' | 'title' | 'description'>) => VNode | string);
    avatarProps?: RecordType;
    title?: string | ((data: Pick<PlusCheckCardProps, 'avatar' | 'title' | 'description'>) => VNode | string);
    description?: string | ((data: Pick<PlusCheckCardProps, 'avatar' | 'title' | 'description'>) => VNode | string);
    disabled?: boolean;

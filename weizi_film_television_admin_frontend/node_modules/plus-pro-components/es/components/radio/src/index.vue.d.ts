import type { OptionsRow } from 'plus-pro-components/es/types';
...
declare const _default: import("vue").DefineComponent<{
    ...
    radioClick: (e: MouseEvent, val: ValueType, fieldItemProps: OptionsRow['fieldItemProps']) => void;
    change: (val: ValueType) => void;

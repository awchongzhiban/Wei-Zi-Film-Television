import type { PlusCheckCardProps } from 'plus-pro-components/es/components/check-card';
...
declare const _default: import("vue").DefineComponent<{
    ...
    getChecked: (value: SingleValueType) => boolean;
    handleChange: (model: boolean, value: SingleValueType) => void;
    handleExtra: (item: PlusCheckCardProps & {
        value: string | number;
    }) => void;

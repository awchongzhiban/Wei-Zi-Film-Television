...
import { Directive, Plugin, PropType, VNode, Ref } from 'vue';
import { M as MotionVariants, a as MotionInstance, V as Variant, S as StyleProperties, T as TransformProperties, b as TransformValue, P as PermissiveTarget, U as UseMotionOptions, c as MotionProperties, d as MotionTransitions, e as MotionControls, f as MotionInstanceBindings, g as PermissiveMotionProperties, h as SpringControls, i as Spring } from './shared/motion.6686175e.cjs';
export { F as CustomValueType, p as Easing, E as EasingFunction, I as Inertia, s as Keyframes, K as KeyframesTarget, y as MakeCustomValueType, A as MakeKeyframes, Z as ModuleOptions, j as MotionTarget, G as MotionValuesMap, Y as Omit, O as Orchestration, N as PassiveEffect, u as PermissiveTransitionDefinition, t as PopmotionTransitionProps, W as PropertiesKeys, o as Props, q as Repeat, R as ResolvedKeyframesTarget, k as ResolvedSingleTarget, m as ResolvedValueTarget, X as SVGPathProperties, l as SingleTarget, Q as StartAnimation, H as StopAnimation, L as Subscriber, z as Target, C as TargetAndTransition, D as TargetResolver, B as TargetWithKeyframes, J as Transformer, x as Transition, v as TransitionDefinition, w as TransitionMap, r as Tween, n as ValueTarget } from './shared/motion.6686175e.cjs';
...
declare const _default$1: vue.DefineComponent<{
    ...
    preset: {
        type: PropType<"pop" | "fade" | "fadeVisible" | "fadeVisibleOnce" | "popVisible" | "popVisibleOnce" | "rollBottom" | "rollLeft" | "rollRight" | "rollTop" | "rollVisibleBottom" | "rollVisibleLeft" | "rollVisibleRight" | "rollVisibleTop" | "rollVisibleOnceBottom" | "rollVisibleOnceLeft" | "rollVisibleOnceRight" | "rollVisibleOnceTop" | "slideBottom" | "slideLeft" | "slideRight" | "slideTop" | "slideVisibleBottom" | "slideVisibleLeft" | "slideVisibleRight" | "slideVisibleTop" | "slideVisibleOnceBottom" | "slideVisibleOnceLeft" | "slideVisibleOnceRight" | "slideVisibleOnceTop">;
